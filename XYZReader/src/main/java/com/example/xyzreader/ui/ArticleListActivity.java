...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public Adapter(Cursor cursor, Activity host) {
            mCursor = cursor;
            mhost = host;
        }
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            mCursor.moveToPosition(position);
            holder.cardView.setCardElevation(getResources().getDimensionPixelSize(R.dimen.article_cardview_elevation));
            Log.d("CardViewElevation", "ele: "+holder.cardView.getCardElevation());
            ...
            /*holder.cardView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Log.d("ArticleList", "uri:"+ItemsContract.Items.buildItemUri(getItemId(position)).toString());
                    Log.d("ArticleList", "getItemId:"+getItemId(position)+" pos: "+position);
                    Intent intent = new Intent(Intent.ACTION_VIEW,
                            ItemsContract.Items.buildItemUri(getItemId(position)));
                    //startActivity(intent);
                    startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(
                            ArticleListActivity.this, holder.thumbnailView, position+"").toBundle());
                    //ActivityOptions.makeSceneTransitionAnimation(ArticleListActivity.this, holder.cardView, "photo");
                }
            });*/
        }
